...
// 2. 최대 5K 극한 더블 스파이크 스테이지 (TC8)
const spikeStages = [
  { duration: '10s', target: 100 },    // Warm-up
  { duration: '5s',  target: 2000 },   // 1차 스파이크
  { duration: '15s', target: 2000 },   // 1차 유지
  { duration: '5s',  target: 100 },    // 회복
  { duration: '10s', target: 100 },    // 안정화
  { duration: '5s',  target: 5000 },   // 2차 극한 스파이크
  { duration: '15s', target: 5000 },   // 임계점 확인
